# -*- coding: utf-8 -*-
"""临时脚本：抽取《滴天髓阐微》epub 全文 → UTF-8 文本（一次性归档）。"""
import glob
import html
import re
import zipfile

p = glob.glob(r"D:\ai工作区\fortune-assistant\research\Book\滴天髓*.epub")[0]
z = zipfile.ZipFile(p)
...
out = r"D:\ai工作区\fortune-assistant\research\fetched\ditiansui.txt"
