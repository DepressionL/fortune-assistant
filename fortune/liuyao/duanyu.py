...
每条断语均可回溯到通行规则，出处：
- 六亲持世通论：《增删卜易》卷二「六亲持世」歌诀（概括通义，非逐字引用——
  该歌诀在《增删卜易》《卜筮正宗》等传本间文字互有出入，如「子孙持世」首句
  或作「事无忧」/「主无忧」、末句或作「了便休」/「了休休」等；本模块只取
  各本一致的通义，不逐字转写任一版本）；
...
- 月建/日辰对爻的生克冲合（月破、日破、六合绊住等）：《增删卜易》卷二
  「月建章」「日辰章」；
- 旬空（出空填实）：《增删卜易》卷二「旬空章」；
- 六神主事（青龙喜庆、朱雀口舌、勾陈迟滞、螣蛇虚惊、白虎急伤、玄武暗昧）：
  《卜筮正宗》六神章通行归纳（各本象意表措辞有出入，此处取共同核心）。

争议标注：变爻六亲按「本宫五行」论（主流），另有按变卦卦宫论者
（见 research/liuyao_tables.md §6.2）。
...
#: 化进神 8 对（《增删卜易》：亥化子、丑化辰、寅化卯、辰化未、巳化午、
#: 未化戌、申化酉、戌化丑）；化退神即反之。
JIN_SHEN = {("亥", "子"), ("丑", "辰"), ("寅", "卯"), ("辰", "未"),
            ("巳", "午"), ("未", "戌"), ("申", "酉"), ("戌", "丑")}

#: 六亲持世通论（概括自《增删卜易》卷二「六亲持世」歌诀）
SHI_CHI = {
